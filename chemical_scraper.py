...
COMBINED_QUERIES = [
    ...
    {"query": "Polymer resin factory Sanwer Road Sector D Indore", "category": "Polymers & Resins"},
    {"query": "Detergent raw material chemical plant Pithampur Sector 3", "category": "Detergent & Soap Chemicals"},
    {"query": "Water treatment chemical factory Dewas Industrial Area", "category": "Industrial Chemicals"},
    {"query": "Adhesive glue manufacturers Sanwer Road Indore", "category": "Adhesives & Sealants"},
    {"query": "Surfactant manufacturers Pithampur Industrial Belt", "category": "Detergent & Soap Chemicals"},
    {"query": "Agrochemicals manufacturing plant Dewas Sector 1", "category": "Agrochemicals"},
    {"query": "Dyes and pigments factory Sanwer Road Sector C Indore", "category": "Dyes & Pigments"},
    {"query": "Industrial chemical processing unit Kheda Pithampur", "category": "Industrial Chemicals"},

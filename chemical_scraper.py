...
TARGET_TOTAL = 100
FIXED_INDUSTRY = "Chemical Manufacturing & Allied Industries"

# High-Yield Deep Micro-Queries for remaining 35 manufacturing leads
ADDITIONAL_CHEMICAL_QUERIES = [
    ("Specialty Polymers & Masterbatches", "color masterbatch polymer compounds manufacturing plant Indore"),
    ("Industrial Lubricants & Cutting Oils", "industrial lubricating oil coolant grease manufacturing Indore"),
    ("Electroplating & Metal Finishing Chemicals", "electroplating surface treatment chemicals manufacturing Indore Sanwer Road"),
    ("Industrial Gases & Solvents", "industrial oxygen argon dissolved acetylene gas plant Indore"),
    ("Printing Inks & Resins", "gravure flexo printing ink manufacturing plant Indore Palda"),
    ("Silicone & Sealants", "silicone sealants silicone emulsion manufacturing Indore"),
    ("Food Grade Additives & Chemicals", "food grade processing chemicals starch manufacturing Indore"),
    ("Packaging Adhesives & Lamination Glue", "packaging adhesive lamination glue manufacturers Indore Polo Ground"),
    ("Bitumen & Road Construction Emulsions", "bitumen emulsion road construction chemical plant Indore"),
    ("Boiler Water Treatment Formulations", "boiler cooling tower chemical manufacturing Indore Laxmibai Nagar")
]
...
EXCLUDE_TERMS = [
    ...
    "pesticide shop", "paint shop", "fertilizer shop", "agency", "reseller", "hardware",
    "krishi seva", "agri store", "chemical store", "car wash"
]
...
def search_web_fallback(company_name: str):
    try:
        query = f"{company_name} Indore chemical plant contact phone number"
...
def complete_chemical_to_100():
    ...
    print(f"📊 Current Chemical Leads in Database : {current_count}")
    ...
    with sync_playwright() as p:
        ...
        for category_name, query_str in ADDITIONAL_CHEMICAL_QUERIES:
        ...
        browser.close()
        print(f"\n🎉 Target Completed! Total {current_count + saved_session} verified Chemical Manufacturing leads saved.")

if __name__ == "__main__":
    complete_chemical_to_100()